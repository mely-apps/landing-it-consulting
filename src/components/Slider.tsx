  ...
  return (
    <>
      <div className='relative mx-auto w-full max-w-3xl pt-10'>
        <div
          className='relative h-[500px] max-sm:h-[300px] w-full overflow-hidden rounded-lg'
        ...
        <Button
          variant='default'
          size='icon'
          className='absolute left-2 top-1/2 z-10 -translate-y-1/2 hover:opacity-80 transition-all'
          onClick={() => paginate(-1)}
        ...
        <Button
          variant='default'
          size='icon'
          className='absolute right-2 top-1/2 z-10 -translate-y-1/2 hover:opacity-80 transition-all'
          onClick={() => paginate(1)}
