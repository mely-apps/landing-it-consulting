...
//   const onMouseMove = (e) => {
//     const mouseX = (e.clientY - bounds.y - bounds.height / 2) / 10;
//     const mouseY = (e.clientX - bounds.x - bounds.width / 2) / 10;
//     console.log('Y', e.clientX, bounds.x, bounds.width);
//     console.log('X', e.clientY, bounds.y, bounds.height);
...
//       }}
//       className='bg-poster max-sm:hidden sm:h-[500px] sm:w-[360px] lg:mt-[60px] lg:h-[calc(100%_-_8vw_-_66px)] lg:w-[26vw]'
//     >
